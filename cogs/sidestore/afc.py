    ...
    async def afc(self, context: Context) -> None:
        embed = discord.Embed(
            ...
            description=(
                ...
                '2. If issue still persists, generate and import a new pairing file using `idevice pair`. See our [Pairing File instructions](https://docs.sidestore.io/docs/installation/pairing-file) for details'
            )
        )
